...
angular.module('oi.file', [])
  ...
  .value('oiFileConfig', {
    ...
    setError: function (code, data) {
      ...
      var errors = response ? response.errors ? [response.errors] : response : [];
    ...
    return {
      link: function (scope, element, attrs) {
        ...
        function _xhrTransport (uObj) {
          ...
          if (opts.additionalFromData)
            for(var i in opts.additionalFromData)
              form.append(i, opts.additionalFromData[i]);
